...
--(5) Create DOCUMENT table
    CREATE table DOCUMENT(
     DOCUMENT_ID NUMBER,
     DOCUMENT_NAME VARCHAR2, --LENGTH OF CHARACTER
...
CREATE TABLE TRANSACTION_HISTORY(
 TRANSACTION_ID NUMBER,
 TRANSACTION_METHOD VARCHAR2(50 CHAR),
 TRANSACTION_AMOUNT NUMBER,
 TRANSACTION_STATUS VARCHAR2(10 CHAR),
 TRANSACTION_DATE DATE,
 TRANSACTION_TIME VARCHAR2(50 CHAR)
);
...
CREATE TABLE ADMINISTRATOR (
    ...
    ADMIN_ADDRESS VARCHAR2(50),
    ADMIN_POSITION VARCHAR2(20),
    ADMIN_ACCESS_LEVEL VARCHAR2(20)
);
