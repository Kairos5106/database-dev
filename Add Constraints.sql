...
-- Adding foreign key reference from PRINT_JOB table
ALTER TABLE PRINT_JOB
...
ALTER TABLE KIOSK_USAGE
ADD CONSTRAINT FK_KIOSK_ID_USAGE FOREIGN KEY (KIOSK_ID) REFERENCES KIOSK(KIOSK_ID) ON DELETE CASCADE;
...
ALTER TABLE KIOSK_USAGE
ADD CONSTRAINT FK_CUSTOMER_ID_USAGE FOREIGN KEY (CUSTOMER_ID) REFERENCES CUSTOMER(CUSTOMER_ID) ON DELETE CASCADE;
...
ALTER TABLE KIOSK_USAGE
ADD CONSTRAINT FK_TRANSACTION_ID_USAGE FOREIGN KEY (TRANSACTION_ID) REFERENCES TRANSACTION_HISTORY(TRANSACTION_ID) ON DELETE CASCADE;
